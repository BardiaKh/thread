...
class VizlyNotebookApp(ExtensionApp):
    ...
    extension_url = Unicode("/vizly-notebook", config=True,
    ...
    def initialize_handlers(self):
        ...
        handlers = [
            (url_path_join(self.serverapp.base_url, self.extension_url, "/uniqueId"),
                UniqueIdHandler, {"display_url": self.serverapp.display_url}),
            (url_path_join(self.serverapp.base_url, self.extension_url, "/favicon.ico"),
                RedirectHandler, {"url": self.serverapp.base_url + "/favicon.ico"}),
            (url_path_join(self.serverapp.base_url, self.extension_url, r"/(?!api)(.*)"),
